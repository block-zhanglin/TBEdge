...
import com.zl.blockgateway.net.configuration.NetcoreConfiguration;
...
public class GatewayServer {
    ...
    public GatewayServer(NetcoreConfiguration netcoreConfiguration, HttpServerHandlerResolver httpServerHandlerResolver){
        super();
    ...
    public void start() {
        ...
        try {
            ...
            f.channel().closeFuture().sync(); //用来监听客户端连接服务端的结果反馈，Netty是异步操作，无法知道什么时候执行完成，因此可以通过channelfuture来进行执行结果的监听
