...
public class BlockchainNetCoreFactory {
     ...
     */
    public static BlockchainNetCore createDefaultBlockchainNetCore(Account account, ToCaresponse CloundCA){
        return createBlockchainNetCore(ResourcePathTool.getDataRootPath(),account,CloundCA);
    }
     ...
     */
    public static BlockchainNetCore createBlockchainNetCore(String netcorePath,Account account,ToCaresponse CloundCA){
        ...
        HttpServerHandlerResolver httpServerHandlerResolver=new HttpServerHandlerResolver(account,CloundCA,netCoreConfiguration,blockchainCore,nodeService);//创建节点服务处理器
        ...
        BlockchainHeightSearcher blockchainHeightSearcher = new BlockchainHeightSearcher(netCoreConfiguration,nodeService,blockchainCore);
        ...
        EsBlockSearcher esBlockSearcher=new EsBlockSearcher(netCoreConfiguration,blockchainCore,slaveBlockchainCore,nodeService);
        BlockUnload blockUnload=new BlockUnload(netCoreConfiguration,nodeService,blockchainCore,esBlockSearcher,account,CloundCA,blockchainHeightSearcher);
