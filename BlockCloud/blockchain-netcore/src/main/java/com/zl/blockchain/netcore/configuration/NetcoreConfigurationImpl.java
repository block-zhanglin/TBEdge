...
public class NetcoreConfigurationImpl implements NetcoreConfiguration {
    ...
    private int port= Integer.valueOf(API.Cport);//服务器端口号

    private String CloundName=API.CloundName;//设备编号
    ...
    private static final long SEARCH_NODE_TIME_INTERVAL = 1000 *1*60;
    ...
    //在区块链网络中自动搜索节点的区块链高度的时间间隔
    private static final long SEARCH_BLOCKCHAIN_HEIGHT_TIME_INTERVAL = 1000 *60;
