...
public class EsServer {
    ...
    public EsServer(NetcoreConfiguration netcoreConfiguration, HttpServerHandlerResolver httpServerHandlerResolver){
        super();
    ...
    public void start() {
        ...
        try {
            ...
            killServer.killport(po);
            System.out.println("启动失败sssssssss");
        } finally {
