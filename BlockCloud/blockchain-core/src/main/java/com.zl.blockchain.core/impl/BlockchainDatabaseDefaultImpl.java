...
public class BlockchainDatabaseDefaultImpl extends BlockchainDatabase {
     ...
     */
    public BlockchainDatabaseDefaultImpl(CoreConfiguration coreConfiguration) {
...
//        //检验区块的签名
    ...
    public Block blockDto2Block(BlockDto blockDto) {
        ...
        //如果前一个区块为创世区块
        if(previousBlockHash==GenesisBlockSetting.HASH){
            ...
            long blockHeight = GenesisBlockSetting.HEIGHT+1; //获取前一个区块的下一个区块的高度=====即当前区块的高度
